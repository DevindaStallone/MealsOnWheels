...
import "./css/TermsAndConditionPage.css";

const TermsAndCondition = () => {
  return (
    <Layout>
      <div className="terms">
        <div className="container justify-content-center allign-items-center">
          <h1 className="text-center py-5 text-dark fw-bold">
            Terms And Condition
          </h1>
          <div className="terms-detail pb-5 justify-content-center">
            <p className="justify-content-center"> 
              Welcome to Meals on Wheels!
              <br />
              These terms and conditions outline the rules and regulations for the use of Meals on Wheels's Website, located at mealsonwheels.com.
              <br />
              By accessing this website we assume you accept these terms and
              conditions. Do not continue to use Meals on Wheel if you do not
              ...
              Cookies
              <br />
              We employ the use of cookies. By accessing Meals on Wheel, you
              agreed to use cookies in agreement with the Meals on Wheels's
              Privacy Policy.
              <br />
              ...
              License
              <br />
              Unless otherwise stated, Meals on Wheels and/or its licensors own
              the intellectual property rights for all material on
              mealsonwheels. All intellectual property rights are reserved. You
              may access this from mealsonwheels for your own personal use
              subjected to restrictions set in these terms and conditions.
              <br />
              You must not:
              <br />
              <ul>
                <li>Republish material from Meals on Wheel</li>
                <li>Sell, rent or sub-license material from Meals on Wheel</li>
                <li>
                  Reproduce, duplicate or copy material from Meals on Wheel
                </li>
                <li>Redistribute content from Meals on Wheel</li>
              </ul>
              ...
              Meals on Wheels does not filter, edit, publish or review Comments
              prior to their presence on the website. Comments do not reflect
              the views and opinions of Meals on Wheels,its agents and/or
              ...
              applicable laws, Meals on Wheels shall not be liable for the
              ...
              <br />
              Meals on Wheels reserves the right to monitor all Comments and to
              ...
              You hereby grant Meals on Wheels a non-exclusive license to use,
              ...
              Meals on Wheels; and (d) the link is in the context of general
              ...
              by sending an e-mail to Meals on Wheels. Please include your name,
              ...
              No use of Meals on Wheels's logo or other artwork will be allowed
